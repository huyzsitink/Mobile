...
shared.LoaderTitle = "kyrozenx Hub Welcome...";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://103985507475473",
...
local v15 = v14:CreateWindow({
    Title = "kyrozenx Hub Blox-Fruit [ Premium ]",
    SubTitle = "By _Trixie",
    TabWidth = 160,
    Theme = "Light",
    Acrylic = false,
...
local v16 = {
    ...
    Sea = v15:AddTab({
        Title = "Tab Auto Sea Event"
    }),
    ITM = v15:AddTab({
        Title = "Tab Get Item"
    }),
    Setting = v15:AddTab({
        Title = "Tab Setting Hub"
    }),
    Status = v15:AddTab({
        Title = "Tab Sever"
    }),
